...
This dashboard gives you an overview of the popularity statistics and activities of our **[Open Science MOOC](https://opensciencemooc.eu/)** on [GitHub](https://github.com/opensciencemooc). 
...
contributions <- contributors_df %>%
  ...
  pull()
valueBox(contributions, icon = "fa-keyboard", color = "#91aac3")
```
...
This interactive plot shows the GitHub collaboration network. The top three contributors who collaborated the most are highlighted. Hover over a node to see the collaborator's name.
