...
*Data for this analysis was last retrieved on June 07, 2019. Source code can be found [here](https://github.com/lhehnke/openscience-github).*
...
### This interactive plot shows the collaboration network. The top three contributors who collaborated the most with other contributors are highlighted. Hover over a node to see the contributors' name. You can drag and zoom them if you like.
